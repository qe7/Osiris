...
public class NetworkManager {
    ...
    public void addToSendQueue(Packet packet) {
        ...
        final OutgoingPacketEvent outgoingPacketEvent = new OutgoingPacketEvent(packet);
        Osiris.getInstance().getEventBus().post(outgoingPacketEvent);
    ...
    private boolean readPacket() {
        ...
        try {
            ...
            if (packet != null) {
                final IncomingPacketEvent incomingPacketEvent = new IncomingPacketEvent(packet);
                Osiris.getInstance().getEventBus().post(incomingPacketEvent);
