...
public abstract class EntityPlayer extends EntityLiving {
    ...
    public EnumStatus sleepInBedAt(int par1, int par2, int par3) {
        if (!worldObj.isRemote) {
            ...
            double d = 8D;
            double d1 = 5D;
            List list = worldObj.getEntitiesWithinAABB(EntityMob.class, AxisAlignedBB.getBoundingBoxFromPool((double) par1 - d, (double) par2 - d1, (double) par3 - d, (double) par1 + d, (double) par2 + d1, (double) par3 + d));
