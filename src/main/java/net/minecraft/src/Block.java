...
public class Block {
    ...
    public boolean shouldSideBeRendered(IBlockAccess par1IBlockAccess, int par2, int par3, int par4, int par5) {
        if (Osiris.getInstance().getModuleManager().getMap().get(XRayModule.class).isEnabled()) {
            return XRayModule.isBlockID(blockID);
        } else if (par5 == 0 && minY > 0.0D) {
            return true;
        } else if (par5 == 1 && maxY < 1.0D) {
            return true;
        } else if (par5 == 2 && minZ > 0.0D) {
            return true;
        } else if (par5 == 3 && maxZ < 1.0D) {
            return true;
        } else if (par5 == 4 && minX > 0.0D) {
            return true;
        } else if (par5 == 5 && maxX < 1.0D) {
            return true;
        } else {
