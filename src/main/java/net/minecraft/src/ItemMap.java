...
public class ItemMap extends ItemMapBase
{
    ...
    public static MapData getMPMapData(short par0, World par1World)
    {
        ...
        MapData mapdata = (MapData)par1World.loadItemData(MapData.class, (new StringBuilder()).append("map_").append(par0).toString());
    ...
    public MapData getMapData(ItemStack par1ItemStack, World par2World)
    {
        ...
        MapData mapdata = (MapData)par2World.loadItemData(MapData.class, (new StringBuilder()).append("map_").append(par1ItemStack.getItemDamage()).toString());
