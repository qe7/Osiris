...
public class EntityOcelot extends EntityTameable
{
    ...
    public EntityOcelot(World par1World)
    {
        ...
        tasks.addTask(4, new EntityAIAvoidEntity(this, EntityPlayer.class, 16F, 0.23F, 0.4F));
        ...
        targetTasks.addTask(1, new EntityAITargetNonTamed(this, EntityChicken.class, 14F, 750, false));
    }
