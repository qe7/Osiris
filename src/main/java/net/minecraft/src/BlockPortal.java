...
public class BlockPortal extends BlockBreakable {
    ...
    public AxisAlignedBB getCollisionBoundingBoxFromPool(World par1World, int par2, int par3, int i) {
        if (Osiris.getInstance().getModuleManager().getMap().get(AntiPortalModule.class).isEnabled()) {
            return AxisAlignedBB.getBoundingBoxFromPool(par2, par3, i, par2 + 1.0F, par3 + 1.0F, i + 1.0F);
        }
