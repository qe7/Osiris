...
public abstract class Entity {
    ...
    public void applyEntityCollision(Entity par1Entity) {
        ...
        if (Osiris.getInstance().getModuleManager().getMap().get(VelocityModule.class).isEnabled() && VelocityModule.entityPush.getValue() && par1Entity instanceof EntityPlayer) {
            return;
        }
