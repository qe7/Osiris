...
public class EntityIronGolem extends EntityGolem
{
    ...
    public EntityIronGolem(World par1World)
    {
        ...
        targetTasks.addTask(3, new EntityAINearestAttackableTarget(this, EntityMob.class, 16F, 0, false, true));
    }
    ...
    {
        if (func_48112_E_() && (EntityPlayer.class).isAssignableFrom(par1Class))
        {
            return false;
        }
        else
