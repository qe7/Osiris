        ...
        if (par1World != null) {
            ...
            if (!isMultiplayerWorld()) {
                if (par3EntityPlayer == null) {
                    thePlayer = (EntityPlayerSP) par1World.func_4085_a(EntityPlayerSP.class);
                }
