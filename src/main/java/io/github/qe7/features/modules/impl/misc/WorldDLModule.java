...
public class WorldDLModule extends Module {
	...
	public WorldDLModule() {
	    super("WorldDL", "Downloads server's world to your computer", ModuleCategory.MISC);
	...
	public void stopDownload() {
	    ...
	    worldclient.worldInfo.setWorldName(String.valueOf(mc.gameSettings.lastServer) + " " + System.currentTimeMillis());
	    worldclient.downloadThisWorld = false;
	    worldclient.downloadChunkLoader = null;
	    worldclient.downloadSaveHandler = null;
	    this.isDownloading = false;
	    ChatUtil.addPrefixedMessage("WorldDL", "§cDownload stopped.");
	}
	    ...
	    ChatUtil.addPrefixedMessage("WorldDL", "§cDownloading everything you can see...");
	    ChatUtil.addPrefixedMessage("WorldDL", "§6You can increase that area by travelling around.");
	}
